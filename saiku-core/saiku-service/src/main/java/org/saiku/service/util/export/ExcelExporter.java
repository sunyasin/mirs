...
public class ExcelExporter {
    ...
    public static byte[] exportExcel(CellSet cellSet,
        ...
        return exportExcel(table, formatter, filters, null);
    }
    ...
    public static byte[] exportExcel(CellDataSet table,
        ...
        exb.reportName = reportName;
        return getExcel(table, filters, exb);
    }

    public static byte[] exportExcelXls(CellDataSet table,
                                     ICellSetFormatter formatter,
                                     List<ThinHierarchy> filters,
                                     String reportName) {
        ExcelBuilderOptions exb = new ExcelBuilderOptions();
        ...
        exb.asXls = true;
        exb.reportName = reportName;
        ExcelWorksheetBuilder worksheetBuilder = new ExcelWorksheetBuilder(table, filters, exb);
