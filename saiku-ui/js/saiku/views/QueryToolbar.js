...
var QueryToolbar = Backbone.View.extend({
    ...
    switch_render_button: function(event) {
        ...
        if ($target.hasClass('render_chart')) {
            ...
            $('.export_button').removeClass('hidden');
        } else {
			...
			$("#save_icon").removeClass("disabled");
    ...
    spark_bar: function() {
        ...
        // if ($(this.el).find('ul.table .spark_bar')[0].classList.contains("on")||
		// 	$(this.el).find('ul.table .spark_line')[0].classList.contains("on")){
		// 	$(".export_scrollbox > div:first-child").addClass("disabled");
		// 	$(".save.button > div.save_button").addClass("disabled");
		// }
		...
		if ($("ul.table .spark_line")[0].classList.contains("on")
			|| $("ul.table .spark_bar")[0].classList.contains("on")
			|| $("#stats_icon")[0].classList.contains("on")) {
			$(".export_scrollbox").addClass("disabled");
			$("#save_icon").addClass("disabled");
		} else {
			$(".export_scrollbox").removeClass("disabled");
			$("#save_icon").removeClass("disabled");
		}
