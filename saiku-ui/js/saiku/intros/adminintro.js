	...
	$.getJSON("/js/saiku/intros/workspace.json", function (json) {
		...
		intro.setOptions({
				"steps": [
					...
					{
						"element": document.querySelectorAll('#export_ods_icon')[0],
						"intro": "Export the table to ODS",
						"position": "right"
					},
					{
						"element": document.querySelectorAll('#export_ots_icon')[0],
						"intro": "Export the table to OTS",
						"position": "right"
					},
					{
