var Fullscreen = Backbone.Model.extend({
    ...
    add_button: function() {
        ...
        if (!supportsFullScreen)
            return;
        // var button =
        //     $('<div style="position:absolute;left:105px;    background: linear-gradient(to top, #eaeaea, #ffffff);border: 1px solid #dfdfdf;border-radius: 3px;height: 26px;">' +
			// 	'<a style="background-image: url(\'js/saiku/plugins/Fullscreen/fullscreen.png\'); background-repeat:no-repeat;background-position:50% 50%;'+
			// 'background-size: 16px\" href="#fullscreen" id="fullscreen_icon" class="fullscreen button disabled_toolbar i18n" title="Полный экран"></a></div>')
        //     .css({
        //         });
